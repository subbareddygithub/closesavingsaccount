...
@Service
public class SavingsAccount RestProcessor implements RestApiInterface {
	private static final Logger logger = LoggerFactory.getLogger(SavingsAccount RestProcessor.class);
	...
	public Object exceptionMessage(Exception e, String requestObj) {//NOSONAR
		...
		if(e instanceof  HttpClientErrorException){
			if(((HttpClientErrorException) e).getStatusCode().equals(HttpStatus.NOT_FOUND) ||
				...
				apiError.setMessage("API called failed in " +  SavingsAccount RestProcessor.class.getName());
			...
			error.setMessage("Error occurred in "+ SavingsAccount RestProcessor.class.getName());
